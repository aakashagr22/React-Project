...
const OnboardingLight: React.FC = () => {
  const [travelOption, setTravelOption] = useState<string>('solo');
  
  return (
    <div className="phone-mockup onboarding-bg-light">
      <StatusBar theme="light" />
      
      <div className="p-5">
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-travel-blue">Plan Your Journey, Your Way!</h2>
          <p className="text-sm text-gray-500 mt-1">Let's create your personalized travel plan</p>
        </div>
...
export default OnboardingLight;
